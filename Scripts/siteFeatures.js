  ...
  $("a").each(function(index, value) {
    ...
    if (anchorTag.hasAttribute("targetDiv")) {
      $(anchorTag).click(function(event) {
        ...
        $("div[divType='pageContent']").hide();
        $("#" + $(anchorTag).attr("targetDiv")).html(
          $("#" + $(anchorTag).attr("targetDiv")).html() + "<br /> <br />"
        );
...
function glossary(word) {
  var x = (document.getElementById("abhyas").innerText =
    "This is the meaning of the word Abhyas");
  return x;
}
