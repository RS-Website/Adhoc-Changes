...
<body style="overflow-x:hidden ;text-align:justify;">
    <form id="form" runat="server" class="container-fluid">
                ...
                <div role="navigation" class="row container-fluid">
                    ...
                    <div role="navigation" class="row navbar-header  container-fluid" id="menuButtonContainer">
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                            ...
                            style="margin-top:0px; margin-bottom:0px;" onclick="MenuToggle();">
                    ...
                    <div role="navigation" class="row collapse navbar-collapse" id="bs-example-navbar-collapse-1"
                        style="z-index:-1;padding:-5px;max-height:600px !important;min-height:600px !important;">
                        <ul class="nav nav-tabs">
                            <li role="presentation" class="active" style="cursor: pointer"><a targetDiv="HomePage">Home
                                    Page</a></li>
                            <li role="presentation" style="cursor: pointer"><a targetDiv="Importantdates">Calendar</a>
                            </li>
                            ...
                            <li role="presentation" style="cursor: pointer"><a targetDiv="SantSatGuru">Sant Sat Guru</a>
                            </li>
                            <li role="presentation" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                                    data-target="#media" role="button" aria-haspopup="true"
                                ...
                                <ul id="#media" style="z-index:999;" class="dropdown-menu">
                                    ...
                                    <li><a targetDiv="ClassSatsang" style="cursor: pointer">Old Satsangs
                                            (1970s/Centenary)</a></li>
                                </ul>
                            </li>
                            <li role="presentation" style="cursor: pointer"><a targetDiv="HolyPlaces">Holy Places</a>
                            </li>
                            <li role="presentation" style="cursor: pointer"><a targetDiv="GenInfo">General
                                    Information</a></li>
                            <!--
                            ...
                            <li role="presentation" style="cursor: pointer"><a targetDiv="Playlist"
                                    id="sidebarCollapse">Playlist</a></li>
        ...
        <!-- Sidebar Holder -->
        <nav id="sidebarplaylist"
            style="margin-top:180px;margin-left:10px;display:none;width:400px;background-color:blue;" class="active">
        ...
        <div id="HomePage" class="row BorderDiv" divType="pageContent">
            ...
            <div class="col-md-12" style="font-size:15px;padding:25px;padding-top:0px;">
                <h5 align=center><mark>New: Information regarding Bhent (offering) is added. For details, please visit
                        the "<b><u>General Information</b></u>" tab from the top menu.</mark></h5>
                <h5 align=center><mark>New: More Sant Bani Shabds have been added. To experience it, please visit the
                        "<b><u>Sant Bani</b></u>" section from the "<b><u>Library</b></u>" tab in the top menu.</mark>
                </h5>

                <h5 align=center><mark>New: Video Shabds are now added. To experience it and know more, please visit the
                        "<b><u>Video Poetry</b></u>" section from the "<b><u>Library</b></u>" tab in the top
                        menu.</mark></h5>
                <h3>INTRODUCTION</h3>
                &emsp;&emsp;Finding the Jivas in acute distress and delusion, and that they have deviated considerably
                from true Parmarth
                ...
                <ul>
                    ...
                    <li>
                        ...
                        and to a certain extent under the control of the forces of mind and matter. It is also comprised
                        of six sub-divisions. </li>
                </ul>
                &emsp;&emsp;The above three grand divisions of the universe have a correspondence, or are on the same
                plane, with similar
...
-->
        ...
        <div id="Importantdates" class="row" divType="pageContent">
            <div class="col-md-12  " style="text-align: justify;">
                ...
                You can find the dates of the festivals of Radhasoami Faith, daily Satsang timings and the link to
                listen to the live Satsang.
                ...
                <!--Please note that the user needs to login in order to listen to the Satsang.</b>-->
                <br />
                Live Satsang is meant for Satsangis of Radhasoami Satsang, Soami Bagh, Agra only and needs login
                credentials to access. Satsangs can be listened on Desktop computers, Laptops and all handheld devices
                like Tablets, Mobiles, etc..
                <br />
                <br />
...
-->
        ...
        <div id="SantSatGuru" class="row" divType="pageContent">
            <div class="col-md-12" style="padding:10px;">
                <h3>SANT SAT GURU</h3>
                &emsp;&emsp;When Radhasoami Dayal incarnated on this earth in the form of Param Purush Puran Dhani
                Soamiji Maharaj, the first
                ...
                <div class="row">
                    ...
                    <div class="col-md-10" style="padding-right:50px;">
                        <div class="row" id="soamjipara" tabindex="1" style="outline:none;">
                            ...
                            &emsp;&emsp;Param Purush Puran Dhani (The Most Supreme and the Most Perfect Being) Soamiji
                            Maharaj is the first Sant Sat Guru
                            ...
                            between 24-25<sup>th</sup> August, 1818 A.D. He was the Perfect Incarnation of Radhasoami
                            Dayal and
                    ...
                    <div id="readmore1" style="text-align: justify;display:none;padding-right:50px;">
                        <br /><br />&emsp;&emsp;Soamiji Maharaj’s name was “Shiv Dayal Singh Seth”. This worldly name of
                        Soamiji Maharaj also has a special significance.
                        ...
                        Dayal, the Lord of Radhasoami Dham, which is situated beyond the seven regions of
                        Sahas-dal-kanwal,
                        ...
                        <br /><br /> &emsp;&emsp;Soamiji Maharaj was the Incarnation of the eighth region, the highest
                        spiritual
                        ...
                        <br /><br /> &emsp;&emsp;The Lord could not come lower down in the same form as His intense
                        spirituality
                        ...
                        <br /><br /> &emsp;&emsp;Soamiji Maharaj possessed an extremely handsome appearance and
                        personality
                        ...
                        to permit it.
                        <br /><br /> &emsp;&emsp;Soamiji Maharaj would, for days together, shut Himself up in a small
                        room
                        ...
                        <br /><br /> &emsp;&emsp;Huzur Maharaj, one of the Nij Ansh and the second Sant Sat Guru, while
                        performing
                        ...
                        <br /><br /> &emsp;&emsp;Soamiji Maharaj started holding Satsang at His residence on Basant
                        Panchmi
                        ...
                        <br /><br /> &emsp;&emsp;As is apparent from the name itself, this book is filled with
                        invaluable
                        ...
                        <br /><br /> &emsp;&emsp;Soamiji Maharaj had spoken to Huzur Maharaj about His departure about
                        two
                        ...
                        <br /><br /> &emsp;&emsp;On the departure day, at about 8 A.M., Soamiji Maharaj observed that
                        the
                        ...
                        <br /><br /> &emsp;&emsp;Annual Bhandara of Soamiji Maharaj was fixed by Huzur Maharaj as Asad
                        Badi
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 " style="text-align: justify;padding-right:50px;">
                        <div class="row" id="radhajipara" tabindex="1" style="outline:none;">
                            ...
                            Radhaji Maharaj was one of the Nij Anshas that Soamiji Maharaj brought along with Him. But
                            She did not function as a Sant
                    ...
                    <div id="readmore2" style="text-align: justify;display:none;padding-right:50px;">
                        ...
                        household duties.
                        <br /><br /> &emsp;&emsp;A very cool and serene current was present in Her. She had not assumed
                        the
                        ...
                        <br /><br /> &emsp;&emsp;To an important question, "Whom have you appointed to look after and
                        guide
                        ...
                        <br /><br /> &emsp;&emsp;Radhaji Maharaj had not any function assigned to Her as in the case of
                        the
                        ...
                        <br /><br /> &emsp;&emsp;Radhaji Maharaj survived Soamiji Maharaj by more than sixteen years.
                        During
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 " style="text-align: justify;padding-right:50px;">
                        <div class="row" id="Huzurpara" tabindex="1" style="outline:none;">
                            ...
                            &emsp;&emsp;Huzur Maharaj was the second Sant Sat Guru of the Radhasoami Faith. He succeeded
                    ...
                    <div id="readmore3" style="text-align: justify;display:none;padding-right:50px;">
                        <br /><br /> &emsp;&emsp;Huzur Maharaj's name was Salig Ram. He had his early education in a
                        Maktab
                        ...
                        <br /><br /> &emsp;&emsp;The first memorable meeting between Soamiji Maharaj and Huzur Maharaj
                        took
                        ...
                        <br /><br /> &emsp;&emsp;The family of Huzur Maharaj consisted of religious-minded persons with
                        catholic
                        ...
                        <br /><br /> &emsp;&emsp;Huzur Maharaj's was a full-fledged household life with large progeny
                        and
                        ...
                        <br /><br /> &emsp;&emsp;At the age of 18, Huzur Maharaj entered Government service. He got an
                        appointment
                        ...
                        <sup>st</sup> July 1852, Huzur Maharaj was made the Head Assistant in the office of the
                        Postmaster
                        ...
                        <br /><br /> &emsp;&emsp;Huzur Maharaj was in Soamiji Maharaj's Satsang for about twenty years
                        during
                        ...
                        <br /><br /> &emsp;&emsp;Huzur Maharaj attended on Soamiji Maharaj from twelve to fifteen hours
                        a
                        ...
                        letter given in chapter 27, Biography of Huzur Maharaj, was written by Huzur Maharaj under
                        instructions from Soamiji
                        Maharaj.
                        <br /><br /> &emsp;&emsp;Soamiji Maharaj had ordained that, in future, Satsang would spread far
                        and
                        ...
                        <br /><br /> &emsp;&emsp;About a week before His departure, Huzur Maharaj strolled a few rounds
                        in
                        ...
                        <br /><br /> &emsp;&emsp;A large number of books, big and small, and treatises in prose and
                        verse,
                ...
                <div class="row">
                    ...
                    <div class="col-md-10" style="text-align: justify;padding-right:50px;">
                        <div class="row" id="Maharaparaj" tabindex="1" style="outline:none;">
                            ...
                            &emsp;&emsp;Maharaj Saheb was the third Sant Sat Guru of Radhasoami Faith. He was born in
                            Piyari Kalan, Kabir Chaura, Varanasi,
                            on Thursday, the 28<sup>th</sup> March 1861. Maharaj Saheb's name was Brahm Shankar. Huzur
                            Maharaj had given Maharaj Saheb the Parmarthi name 'Premanand'.
                    ...
                    <div id="readmore4" style="text-align: justify;display:none;padding-right:50px;">
                        <br /><br /> &emsp;&emsp;Maharaj Saheb was born in a highly respected Brahmin family of
                        intellectuals.
                        ...
                        <br /><br /> &emsp;&emsp;Maharaj Saheb got married at a very early age. His consort was just
                        nine
                        ...
                        <br /><br /> &emsp;&emsp;According to the traditions of the time, Maharaj Saheb paid much
                        attention
                        ...
                        <br /><br /> &emsp;&emsp;At B.A, Maharaj Saheb had English Literature, Sanskrit and Physics as
                        His
                        ...
                        <br /><br /> &emsp;&emsp;Maharaj Saheb got appointed as clerk with Accountant General's Office.
                        Within
                        ...
                        <br /><br /> &emsp;&emsp;Maharaj Saheb used to hold Satsang three times a day, early morning,
                        evening
                        ...
                        <br /><br /> &emsp;&emsp;The idea of erecting a magnificent and stupendous Samadh building
                        befitting
                        the memory of the August Founder of Radhasoami Faith, originated with Maharaj Saheb.
                        <br /><br /> &emsp;&emsp;Maharaj Saheb started dictating the English book "Discourses on
                        Radhasoami
                        ...
                        <br /><br /> &emsp;&emsp;Nearly a century ago Maharaj Saheb had in one of His discourses
                        predicted
                        ...
                        His diet was reduced considerably. He even lost the urge to eat or drink anything. But this was
                        not due to illness
                        ...
                        <br /><br /> &emsp;&emsp;Maharaj Saheb departed on Saturday, the 12th October 1907 in Soami
                        Bagh,
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 " id="bujaji" style="text-align:justify;outline:none;padding-right:50px;"
                        tabindex="1">
                        <h4 style="color: #337ab7">BUAJI SAHEBA</h4>
                        &emsp;&emsp;Buaji Saheba was the elder sister of Maharaj Saheb. She was senior to Maharaj Saheb
                        by four years and functioned
                    ...
                    <div id="readmore5" style="text-align: justify;display:none;padding-right:50px;">
                        <br /><br /> &emsp;&emsp;Very shortly before His departure, Maharaj Saheb in one of His last
                        discourses
                        ...
                        <br /><br /> &emsp;&emsp;Maharaj Saheb often used to say that the next Sant Sat Guru would
                        effect
                        ...
                        <br /><br /> &emsp;&emsp;Buaji Saheba left Her mortal coil at 12.30 in the night between
                        Tuesday,
                        the 20
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 " id="babji" style="text-align: justify;outline:none;padding-right:50px;"
                        tabindex="1">
                        <h4 style="color: #337ab7">BABUJI MAHARAJ</h4>
                        &emsp;&emsp;Babuji Maharaj was the fifth and the last manifest Sant Sat Guru of Radhasoami
                        Faith. Babuji Maharaj was the
                    ...
                    <div id="readmore6" style="text-align: justify;display:none;padding-right:50px;">
                        ...
                        name of "Prem Adhar".
                        <br /><br /> &emsp;&emsp;Babuji Maharaj's mother was a great Parmarthi (pious) lady. She always
                        kept
                        Satsang and Parmarth (spiritual welfare) above all worldly pursuits. In the beginning of 1921,
                        Babuji Maharaj's mother passed away. She could neither
                        see nor hear. She was unmindful and oblivious of any physical injury or pain or even
                        bleeding. She remained in this state for quite some time. Often, she would say, "Look! Soamiji
                        Maharaj, Huzur Maharaj and Maharaj
                        ...
                        <br /><br /> &emsp;&emsp;Babuji Maharaj used to wear long hair during childhood. He was fond of
                        playing
                        ...
                        <br /><br /> &emsp;&emsp;At the age of sixteen Babuji Maharaj was married to Srimati Bhagwan
                        Dei,
                        ...
                        <br /><br /> &emsp;&emsp;Maharaj Saheb and Babuji Maharaj took their M. A. degree in 1884.
                        Thereafter,
                        ...
                        <br /><br /> &emsp;&emsp;When Maharaj Saheb became Sant Sat Guru, Babuji Maharaj considered Him
                        to
                        ...
                        <br /><br /> &emsp;&emsp;Formerly, the members of a certain low caste were not allowed to enter
                        the
                        ...
                        <br /><br /> &emsp;&emsp;Babuji Maharaj used to read the daily papers, magazines, etc. till the
                        end
                        ...
                        <br /><br /> &emsp;&emsp;Babuji Maharaj had no particular disease, except weakness due to old
                        age,
                        ...
                        <br /><br /> &emsp;&emsp;Babuji Maharaj was continually enhancing the flow of His ambrosial
                        grace
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: justify;outline:none;padding-right:50px;" tabindex="1">
                        ...
                        <br />&emsp;&emsp;“When the Sat Guru of the time departs, He appoints someone as His successor
                        in
                        whom He re-incarnates and thus continues the work of regeneration of Jivas as
                        before……….Therefore,
                        an earnest devotee should make no distinction between the previous Sat Guru and His successor.
                        But
                        those who are bigoted devotees will not come under the allegiance to the succeeding Sat Guru.
                        For this reason, their progress will also stop at the stage they had reached during the time of
                        the
                        former Sat Guru and there would be no further progress and improvement”.
                        (Sar Bachan Radhasoami, Prose, Part-2, Bachan-250)
                        <br />&emsp;&emsp;The Sant Sat Guru of the time while present on this plane, may choose not to
                        ‘manifest’
                        immediately. When the Sant Sat Guru of the time is not manifested, there is a period of
                        Interregnum, so to say.
                        Interregnum does not mean that He is not present. He is indeed present but during Interregnum He
                        does not grant
                        His recognition, therefore people do not know His identity. When it is His Mauj, He grants
                        recognition to
                        Adhikari (fit) Jivas. Gradually others also become aware and associate themselves with Him.
                        Indeed, it would not be right to say that there has been no Sant Sat Guru all these years in
                        Radhasoami
                        Satsang, Soamibagh, Agra. The Sant Sat Guru has been present all this time, and He is very much
                        present.
                        He Himself gives His own recognition at the proper time. Those who regularly and daily perform
                        spiritual
                        practices (Sumiran, Dhyan, and Bhajan) do come to know about it internally in the fullness of
                        time.
                        Reliable proof or indication can be had only in the course of performing internal practices.
                        “Till one receives an unmistakable proof within oneself of the manifestation of the Sant Sat
                        Guru, one
                        had better continue to stick to the form of the last Sant Sat Guru.
                        There is no time limit for such a manifestation. It all depends upon His Mauj or the Divine
                        Will.
                        But there should not be any doubt in one’s mind that the divine current is or will ever be
                        withdrawn
                        from this plane, till the redemption of the entire creation has been affected. Hence, having
                        full
                        faith and belief in the words of the Sant Sat Gurus, one should go on applying oneself to
                        Parmarthi
                        pursuits, viz., Sumiran, Dhyan, Bhajan, reading, studying and cogitating upon the holy
                        literature and
                        exchanging views regarding matters of the Faith among brother Satsangis and devotees.” (Holy
                        Epistles, Part-4, Letter-20)
                        If we increase our fitness by following the instructions for making spiritual endeavours:
                        “Satguru Himself would come to meet such a Parmárthi” (Sar Bachan Radhasoami, Poetry,
                        Part-1,Bachan-13, Shabd-1, Couplet -13)
                        <br />&emsp;&emsp;In the absence of a manifest Sant Sat Guru, Huzur Maharaj has indicated the
                        course of
                        action for sincere devotees in Prem Patra, Part 2, Bachan 11. Some extracts from it are given
                        below:
                        “According to the teachings of Sants, the Jiva must attend Satsang once or twice every day till
                        his delusions
                        are somewhat removed. It is a great boon if he luckily gets to Satsang of Sant Sat Guru or Sadh.
                        Otherwise,
                        he should read and study, carefully and attentively, the scriptures of Sants, once or twice
                        daily. Even
                        this would be very beneficial and his ignorance and misunderstanding would be gradually removed,
                        Whenever
                        he can conveniently do so, he should make it a point to visit the head-quarters Satsang at Soami
                        Bagh once
                        or twice a year, or once in two or three years, and stay there for at least a week or two or for
                        a longer
                        duration. He should utilize this opportunity for removing his doubts and misunderstandings and
                        also the
                        impediments and obstacles which hamper his Abhyas (devotional practices). “
                        “Even attendance at the Satsang is not possible without grace and mercy. Radhasoami Dayal, in
                        His grace,
                        fulfils the desire of sincere Parmarthis as and when He considers it proper. Now and then, He
                        creates circumstances
                        favourable for the ardent Parmarthis to attend Satsang and derive benefit therefrom. If no such
                        opportunity
                        is available by Mauj, they are brought in contact with some high class Satsangi from whom they
                        hear spiritual
                        discourses so that they may also begin to progress on the path of salvation. It, however,
                        behoves all Parmarthis
        ...
        <div id="Books" class="row " divType="pageContent">
            <div class="col-md-12">
                <h3>BOOKS</h3>
                You can explore the complete collection of books in available languages here. <br /><u>Note:</u> In case
                of mobiles and laptops, few browsers do not support 'Open/Play online' feature. Hence clicking on play
                online will result into download of the content on laptop or mobile. It can then be accessed locally.
                <asp:Panel ID="Panel10" runat="server" ScrollBars="Auto" Width="100%">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="true"
                        AutoGenerateColumns="false" AlternatingRowStyle-BackColor="#e5e5e5" PageSize="10"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Author/Translator">
                                <ItemTemplate>
                                    <asp:Label ID="authTransEng" runat="server" Text='<%# Bind("authTransEng") %>'>
                                    </asp:Label>
                                </ItemTemplate>
                                <ItemStyle Wrap="true" />
                            </asp:TemplateField>
                ...
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="ddl" Text="Author/Translator"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="DropAuthor" runat="server" Width="228px" Height="25px"
                            ...
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="Label1" Text="Related To"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="DropRelate" runat="server" Width="228px" Height="25px"
                                        AutoPostBack="true" AppendDataBoundItems="true">
                                        <asp:ListItem Value="0" Text="ALL"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="Label2" Text="Language"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="DropLanguage" runat="server" Width="228px" Height="25px"
                                        AutoPostBack="true" AppendDataBoundItems="true">
                                        <asp:ListItem Value="0" Text="ALL"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                        ...
                        <span style="margin-left:5px">
                            <b>
                                <asp:Button runat="server" ID="btn_book" Text="SEARCH" Causevalidater="true" />
                                </b>&emsp;<br /><u style=" color: #337ab7;">Note:</u> Set all search criteria to blank,
                            keep the search box blank and click Search button to reset the table.
                            ...
                            <asp:Panel ID="Panel5" runat="server" ScrollBars="Auto" Width="100%">
                                <asp:GridView ID="GVBook" runat="server" Width="100%" AllowPaging="true"
                                    AutoGenerateColumns="false" AlternatingRowStyle-BackColor="#e5e5e5" PageSize="10"
                                    AllowSorting="True" GridLines="None">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Book Name">
                                            <ItemTemplate>
                                                <asp:Label ID="bNameEng" runat="server" Text='<%# Bind("bNameEng") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Author/Translator">
                                            <ItemTemplate>
                                                <asp:Label ID="authTransEng" runat="server"
                                                    Text='<%# Bind("authTransEng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Language">
                                            <ItemTemplate>
                                                <asp:Label ID="langEng" runat="server" Text='<%# Bind("langEng") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Publication">
                                            <ItemTemplate>
                                                <asp:Label ID="pubEng" runat="server" Text='<%# Bind("pubEng") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Related To">
                                            <ItemTemplate>
                                                <asp:Label ID="related" runat="server" Text='<%# Bind("related") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Book Summary">
                                            <ItemTemplate>
                                                <asp:Label ID="summaryEng" runat="server"
                                                    Text='<%# Bind("summaryEng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Options">
                                            <ItemTemplate>
                                                <a href='<%#Eval("pdfLink")%>' target="_blank"
                                                    style="cursor:pointer;">Read Online</a>
                                                &emsp;&emsp;<a style="cursor:pointer;" data-toggle="tooltip"
                                                    title="Download" href='<%#Eval("pdfLink")%>' download><span
                                                        class="glyphicon glyphicon-save"></a>
                                                ...
                                                <%--<ItemTemplate>
                                                                    <a href="<%#Eval("pdfLink")%>" target="_blank">Read
                                                Online</a>
                                                &emsp;&emsp;<a href="<%#Eval("pdfLink")%>" download><span
                                                        class="glyphicon glyphicon-save"></a>--%>
                                                <%--</ItemTemplate>--%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <div id="Audio" class="row " divType="pageContent">
            <div class="col-md-12">
                <h3>AUDIO</h3>
                Here you can find the complete collection of audio rendetions (by Satsangis) of (i) Discourses, poetry
                of all Sant Sat Gurus
                of Radhasoami Faith and (ii) Poetry of other Sants. The rendetions are in Hindi language.
                <br /><u>Note:</u> In case of mobiles and laptops, few browsers do not support 'Open/Play online'
                feature. Hence clicking on play online will result into download of the content on laptop or mobile. It
...
-->
                <h4>PROSE</h4>
                In the table below, you can listen to the audio rendetions (by Satsangis) of Discourses of all Sant Sat
                Gurus of Radhasoami
                    ...
                    <ContentTemplate>
                        ...
                        <span style="margin-left:5px">
                            ...
                            <asp:Panel ID="Panel3" runat="server" ScrollBars="Auto" Width="100%">
                                <asp:GridView Style="overflow:auto" ID="GVBachan" runat="server" Width="100%"
                                    AllowPaging="true" AutoGenerateColumns="false"
                                    AlternatingRowStyle-BackColor="#e5e5e5" PageSize="10" AllowSorting="True"
                                    GridLines="None">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Book Name">
                                            <ItemTemplate>
                                                <asp:Label ID="BookName_English" runat="server"
                                                    Text='<%# Bind("BookName_English") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Bachan No.">
                                            <ItemTemplate>
                                                <asp:Label ID="Bachan_English" runat="server"
                                                    Text='<%# Bind("Bachan_English") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Bachan Summary">
                                            <ItemTemplate>
                                                <asp:Label ID="Bachan_Summary_English" runat="server"
                                                    Text='<%# Bind("Bachan_Summary_English") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Duration">
                                            <ItemTemplate>
                                                <asp:Label ID="Duration" runat="server"
                                                    Text='<%# Bind("Duration", "{0: hh:mm}")  %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Options">
                                            <ItemTemplate>
                                                ...
                                                <br />
                                                <a href='<%#Eval("Link")%>' style="cursor:pointer;"
                                                    data-toggle="tooltip" title="Download" download><span
                                                        class="glyphicon glyphicon-save"></a>
                                                ...
                                                <button class="btn btn-success addToPlaylist" added="false"
                                                    sname='<%#Eval("plHeader") %>' audiourl='<%#Eval("Link")%>'
                                                    onclick="addToPlaylist('<%#Eval("Link")%>'); return false;"
                                                    duration='<%#Eval("Duration") %>'>Add to playlist</button>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    <PagerStyle HorizontalAlign="Right" CssClass="GridPager" />
        ...
        <div id="Shabd" class="row " divType="pageContent">
            <div class="col-md-12">
                ...
                In the table below, you can listen to the audio rendetions (by Satsangis) of Poetry of Sants of
                Radhasoami Faith. The rendetions
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <span style="margin-left:5px">
                            ...
                            <br />
                            <br />
                            <asp:Label style="color: black; padding-left: 15px;font-size:20px;" Font-Bold="true"
                                runat="server" id="shabderror" Visible="false"
                                Text="No matches found. Please try again..."></asp:Label>
                            <%-- <div id="snackbarShabd">
                                                <h4 style="color: black; padding-left: 15px;">No matches found. Please try again...</h4>
                                            </div>--%>
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Height="300px" Width="100%">
                                <asp:GridView Style="overflow:auto" ID="GVShabd" Width="100%" runat="server"
                                    AllowPaging="true" AutoGenerateColumns="false"
                                    AlternatingRowStyle-BackColor="#e5e5e5" PageSize="10" AllowSorting="True"
                                    GridLines="None">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Shabd Name">
                                            <ItemTemplate>
                                                <asp:Label ID="Shabd_Name_Eng" runat="server"
                                                    Text='<%# Bind("Shabd_Name_Eng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Book Name">
                                            <ItemTemplate>
                                                <asp:Label ID="Book_Name_Eng" runat="server"
                                                    Text='<%# Bind("Book_Name_Eng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Bachan">
                                            <ItemTemplate>
                                                <asp:Label ID="Bachan" runat="server" Text='<%# Bind("Bachan") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Shabd">
                                            <ItemTemplate>
                                                <asp:Label ID="Shabd" runat="server" Text='<%# Bind("Shabd") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Special Occasion">
                                            <ItemTemplate>
                                                <asp:Label ID="SplOccasion_Eng" runat="server"
                                                    Text='<%# Bind("SplOccasion_Eng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Duration">
                                        ...
                                        <asp:TemplateField HeaderText="Options">
                                            <ItemTemplate>
                                                ...
                                                <div> <audio controlsList="nodownload" controls="controls"
                                                        class="tableAudio">
                                                        <source src='<%#Eval("Link")%>' )' type="audio/mp3">
                                                    </audio> </div>
                                                <br />
                                                ...
                                                <!-- <a onclick ="downcheck('<%#Eval("Link")%>')" style ="cursor:pointer;" data-toggle="tooltip" title="Download" download><span class="glyphicon glyphicon-save"></a> -->
                                                <button class="btn btn-success addToPlaylist" added="false"
                                                    sname='<%#Eval("Shabd_Name_Eng") %>'
                                                    onclick="addToPlaylist('<%#Eval("Link")%>'); return false;"
                                                    audiourl='<%#Eval("Link")%>' duration='<%#Eval("Duration") %>'>Add
                                                    to playlist</button>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
        ...
        <div id="SantBani" class="row " divType="pageContent">
            <div class="col-md-12">
                <br />
                <h4>SANT BANI</h4>
                In the table below, you can listen to the audio rendetions (by Satsangis) of Poetry of Sants of other
                Faith. The rendetions
                are in Hindi language.
                <br /><u>Note:</u> In case of mobiles and laptops, few browsers do not support 'Open/Play online'
                feature. Hence clicking on play online will result into download of the content on laptop or mobile. It
                can then be accessed locally.
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="GVPanel" runat="server" ScrollBars="Auto" Width="100%">
                            <asp:GridView Style="overflow:auto" ID="GVSantBani" Width="100%" runat="server"
                                AllowPaging="true" AutoGenerateColumns="false" AlternatingRowStyle-BackColor="#e5e5e5"
                                PageSize="10" AllowSorting="True" GridLines="None">
                                <Columns>
                                    <asp:TemplateField HeaderText="Shabd Name">
                                        <ItemTemplate>
                                            <asp:Label ID="ShabdName" runat="server"
                                                Text='<%# Bind("ShabdName_English") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="true" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Author">
                                        <ItemTemplate>
                                            <asp:Label ID="AuthorEnglish" runat="server"
                                                Text='<%# Bind("Author_English") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="true" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Category">
                                        <ItemTemplate>
                                            <asp:Label ID="category_English" runat="server"
                                                Text='<%# Bind("category_English") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="true" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Part of Sankalan">
                                        <ItemTemplate>
                                            <asp:Label ID="PartOfSankalan" runat="server"
                                                Text='<%# Bind("PartOfSankalan") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="true" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Duration">
                                    ...
                                    <asp:TemplateField HeaderText="Options">
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            <a href='<%#Eval("Link")%>' style="cursor:pointer;" data-toggle="tooltip"
                                                title="Download" download><span class="glyphicon glyphicon-save"></a>
                                            <!-- <a onclick ="downcheck('<%#Eval("Link")%>')" style ="cursor:pointer;" data-toggle="tooltip" title="Download" download><span class="glyphicon glyphicon-save"></a> -->
                                            <button class="btn btn-success addToPlaylist" id="btnlist" added="false"
                                                sname='<%#Eval("ShabdName_English") %>'
                                                onclick="addToPlaylist('<%#Eval("Link")%>'); return false;"
                                                audiourl='<%#Eval("Link")%>' duration='<%#Eval("Duration") %>'>Add to
                                                playlist</button>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                    ...
                    <ContentTemplate>
                        ...
                        <span style="margin-left:5px">
                            ...
                            <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" Width="100%">
                                <asp:GridView Style="overflow:auto" ID="GVVideoC" Width="100%" runat="server"
                                    AllowPaging="true" AutoGenerateColumns="false"
                                    AlternatingRowStyle-BackColor="#e5e5e5" PageSize="10" AllowSorting="True"
                                    GridLines="None">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Video Clip Name">
                                            <ItemTemplate>
                                                <asp:Label ID="Clip_Title_Eng" runat="server"
                                                    Text='<%# Bind("Clip_Title_Eng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Video Clip Summary">
                                            <ItemTemplate>
                                                <asp:Label ID="Clip_Sum_Eng" runat="server"
                                                    Text='<%# Bind("Clip_Sum_Eng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Duration">
                                            <ItemTemplate>
                                                <asp:Label ID="Duration" runat="server"
                                                    Text='<%# Bind("Duration", "{0: HH:mm:ss}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Remarks">
                                            <ItemTemplate>
                                                <asp:Label ID="Remarks" runat="server" Text='<%# Bind("Remarks") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Options">
                                            <ItemTemplate>
                                                ...
                                                &emsp;&emsp;<a href="<%#Eval("vclipLink")%>" download><span
                                                        class="glyphicon glyphicon-save"></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
        ...
        <div id="Videopoetry" class="row " divType="pageContent">
            <div class="col-md-12">
                <br />
                <h4>VIDEO POETRY</h4>
                You can explore the video poetry (Hymns) related to Sant Sat Gurus of Radhasoami Faith. These videos
                play the recitition of the hymn and also displays synchronized words in English, Hindi & Romanized text.
                It will help a Satsangi to recite the hymn along with the words.
                <br /><u>Note:</u> In case of mobiles and laptops, few browsers do not support 'Open/Play online'
                feature. Hence clicking on play online will result into download of the content on laptop or mobile. It
                can then be accessed locally.
                    ...
                    <ContentTemplate>
                        ...
                        <span style="margin-left:5px">
                            ...
                            <asp:Panel ID="Panel4" runat="server" ScrollBars="Auto" Width="100%">
                                <asp:GridView ID="GVVideoP" runat="server" AllowPaging="true" Width="100%"
                                    AutoGenerateColumns="false" AlternatingRowStyle-BackColor="#e5e5e5" PageSize="10"
                                    AllowSorting="True" GridLines="None">
                                    <Columns>
...
-->
                                                ...
                                                &emsp;&emsp;<a href="<%#Eval("videoLink")%>" download><span
                                                        class="glyphicon glyphicon-save"></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
        ...
        <div id="ClassSatsang" class="row " divType="pageContent">\
            <div class="col-md-12">
                ...
                You can browse through and listen to the Old Satsangs of 1970s and the subsequent Centenary Satsangs.
                These Satsangs will give you an idea as to how the Satsang was conducted at that time.
                This section also has Centenary Satsangs of Soamiji Maharaj (1978), Huzur Maharaj (1998) and Soamiji
                Maharaj (2018).
                <br /><u>Note:</u> In case of mobiles and laptops, few browsers do not support 'Open/Play online'
                feature. Hence clicking on play online will result into download of the content on laptop or mobile. It
                can then be accessed locally.
                    ...
                    <ContentTemplate>
                        ...
                        <span style="margin-left:5px">
                            ...
                            <asp:Panel ID="Panel7" runat="server" ScrollBars="Auto" Width="100%">
                                <asp:GridView ID="GVClassic" runat="server" AllowPaging="true" Width="100%"
                                    AutoGenerateColumns="false" AlternatingRowStyle-BackColor="#e5e5e5" PageSize="10"
                                    AllowSorting="True" GridLines="None">
                                    <Columns>
                                        <asp:TemplateField HeaderText="S. No.">
                                            <ItemTemplate>
                                                <asp:Label ID="satsang_ID" runat="server"
                                                    Text='<%# Bind("satsang_ID") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Holy Place & Time">
                                            <ItemTemplate>
                                                <asp:Label ID="holy_place_time" runat="server"
                                                    Text='<%# Bind("holy_place_time_eng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Date">
                                            <ItemTemplate>
                                                <asp:Label ID="date" runat="server" Text='<%# Bind("date_str") %>'>
                                                </asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks">
                                            <ItemTemplate>
                                                <asp:Label ID="remarks" runat="server"
                                                    Text='<%# Bind("remarks_eng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Details">
                                            <ItemTemplate>
                                                <asp:Label ID="details" runat="server"
                                                    Text='<%# Bind("details_eng") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Options">
        ...
        <div id="HolyPlaces" class="row" divType="pageContent">
            <div class="col-md-12" style="padding-right:50px;">
                ...
                <div id="SoamiBagh" class="row ">
                    ...
                    <div class="col-md-12  " style="text-align: justify;">
                        <h4 style=" color: #337ab7">ABOUT SOAMI BAGH, AGRA
                            <span>
                                <a target="_blank" href="https://goo.gl/maps/Yp5Xh7whGd82" id="map12">
                                    <img src="../images/location.jpg" style="outline:none;" height="25" width="25"
                                        alt="bottle" class="thumbnails" />
                                </a>
                            </span>
                        </h4>
                    ...
                    <div class="col-md-12 " id="grab" style="width:100%;text-align: justify;outline:none" tabindex="1">
                        &emsp;&emsp;Soamiji Maharaj had His residence in the city. On account of charities and
                        alms-giving, His house was all the
                    ...
                    <div id="readmore7" style="text-align: justify;display:none">
                        <br /><br />&emsp;&emsp;At this site there was a piece of elevated land in the centre. Soamiji
                        Maharaj
                        ...
                        <br /><br /> &emsp;&emsp;One morning, Soamiji Maharaj was taking a walk in the garden with three
                        or four
                        ...
                        <br /><br /> &emsp;&emsp;The entire Soami Bagh is a sanctuary for Satsangis because Soamiji
                        Maharaj,
                        ...
                        Soami Bagh). It is as healthy as Ghee (clarified butter). Children playing, sporting,
                        frolicking,
                        walking, racing etc. in this garden (Soami Bagh) is as good as performing Abhyas or the
                        devotional
                        practices.
                ...
                <div class="row">
                    <div class="col-md-2" style="text-align: justify; margin-bottom: 10px; max-height: 180px">
                        <img src="images/HOLYSOAMJI.png" alt="image2" style="border-radius: 70%" width="180"
                            height="180" />
                    </div>
                    <div class="col-md-10" id="Holy" style="text-align: justify;outline:none" tabindex="1">
                        ...
                        &emsp;&emsp;Holy Samadh is located in the premises of Soami Bagh, Agra. The construction of
                        Samadh started in 1904 and continued till 1907. It was temporarily suspended from 1907 to 1923.
                        Since 1923, the construction is going on uninterruptedly and the main dome has been completed in
                        2018. The total height of the whole structure is 193 feet. The four minarets are 104 feet high
                        over the plinth of the main structure.
                    ...
                    <div id="readmore8" style="text-align: justify;display:none">
                        <br /><br />&emsp;&emsp;The soil in Soami Bagh is sandy and foundations laid on it could not be
                        expected to support the weight of such a massive structure. Hence, it was considered necessary
                        to sink 52 wells to be connected with arches on which to build its walls. The wells are of
                        different sizes, their diameters varying according to the requirements of the main structure in
                        different places, from 5.5 feet to 10.5 feet and depths from 40 feet to 45 feet so as to reach
                        the layer of hard soil, technically called ‘Mota’, in each case. The masonry of the foundation
                        wells consists of bricks and lime. The wells have been filled with brick, concrete and lime. On
                        the top of each well is constructed a base consisting of huge blocks of stones of 6 sq.ft and
                        2.5 feet thick in two layers. Over the bases, arches of stones 2.5 feet thick, in two cross
                        layers, have been constructed and the wells thus connected with one another.
                        <br /><br />&emsp;&emsp;The main structure consists of a hall, 68 feet by 68 feet surrounded by
                        verandahs 15 feet wide on all sides. The width of the walls is 3 feet. The main structure is 110
                        sq.ft. There is a 55 feet broad platform round it, thus making the whole structure 220 sq.ft.
                        The platform is 15.5 feet above the ground level. In the platform, there are 52 rooms, 13 on
                        each side. The rooms are 10 feet broad but of different lengths. They have been provided with a
                        verandah 8 feet broad. In front of this verandah, all around there is again a platform 10 feet
                        broad with 4 steps all round leading to a 20 feet broad canal having water 5 feet deep. Beyond
                        this canal there will be a road 20 feet wide paved with red sand stone. The floor of the main
                        hall will be exactly 20 feet high above the level of the red sand-stone road. On each of the
                        four corners of the verandahs there is a Burj (pinnacle). In the south west corner, the Burj
                        will meet ‘Bhajan Ghar’, and the platform in front of the verandah of the rooms in the plinth
                        will merge in ‘Bhajan Ghar’ and so also the canal. In order that Bhajan Ghar may remain intact,
                        it is proposed to let the water of the canal flow to its south and west.
                        <br /><br />&emsp;&emsp;The sacred well in the garden is considered to be an important relic. It
                        is exactly on the north of the flight of stairs leading to the main entrance from the outer edge
                        of the canal. Another well on the south of the steps has also been made to preserve the
                        symmetry. The first storey of the verandahs is 21.25 feet high and has a gallery 4 feet 7 inches
                        wide jutting into the main hall. This may be especially useful for accommodating ladies at the
                        time of congregational services. The height of the second storey of the verandahs is 20.25 feet
                        at which level the height of the main hall reaches 41.4 feet. At a further height of 14 feet by
                        means of corbelling series of semi-circular arch rings one over the other, octagonal plinth of
                        the dome is formed on the outer side. To form a circular ring above the plinth, masonry in
                        cement on the inside of a total height of 13.25 feet is projected. It is decorated with hill
                        scenery. Here the diameter of the dome is 54.5 feet. The outside of the hill scenery forms the
                        neck of the dome. The second gallery for visitors to go and see the dome work and also for
                        labourers for cleaning etc. has been provided 6.75 feet above the hill scenery on projecting
                        masonry. There is a colonnade of round pillars 11.25 feet high above the foot of the gallery all
                        round it, as though it forms the neck of the inside arch of the dome. On the outside, the base
                        of the dome over the neck is 14.75 feet and the lower outer segment of the dome which is 39 feet
                        high over the basement proper is 11 feet thick of brick in cement in 3 rings with 3 inches thick
                        marble panels on the outside and over this ring rises the cap of the dome 91 feet above the
                        lower semicircular arch. Above this cap there will be a golden copper Kalash 32 feet high. Thus,
                        the The verandah pillars are octagonal in shape. They are marble monoliths 6 feet, 5 inches high
                        and 21 feet in diameter, supported on a carved base 11 feet thick of marble 31 sq.ft and covered
                        with elaborately carved caps 21 feet thick of marble 31 sq.ft. To add to the beauty of the
                        elevation on the north and south, 8 round pillars on each side have been provided on projecting
                        masonry. To give a clear idea of what the structure would be like and for the future guidance of
                        engineers, architects, artists, workers. etc., a miniature model has been prepared. It was
                        completed in June 1928.The scale of the model is 21 feet equal to 1 inch.
                        <br />
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<b>ARCHITECTURAL BEAUTY</b>
                        <br /><br />&emsp;&emsp;A look at the model of the building, together with the details given
                        above, and the exquisite beauty of the relief carving in marble and the inlaid stone work done
                        so far, would give some idea of the grandeur of the building, as it will stand when completed.
                        Even as it is, the Samadh and its miniature model are visited by thousands of tourists every
                        day. The building has an oriental setting, but different styles of architecture have been
                        beautifully blended to denote the catholicity of the Radhasoami religion, which has, among its
                        members, peoples of different nationalities. For the same reason, monograms have been provided
                        in different characters, viz. Hindi, Persian and English. In a building of this kind it is
                        natural that construction should go slow, principally due to the elaborate and exquisite marble
                        carving and variegated and exuberant ornamentation, which are the special features of this
                        building. Such work, involving intricate details, cannot be done expeditiously. A single large
                        marble slab, with its skilled carvings of fruit trees, flowers and foliage, takes years to
                        complete it.
                        <br /><br />&emsp;&emsp;Ceilings of the verandahs have been constructed with marble slabs 4
                        inches, 5 inches and 6 inches thick and about 2 sq.ft fitted into one another, without the
                        support of steel or any other girders. The ceiling is certainly a remarkable feat of engineering
                        skill and design. Entire expenditure on the construction of the building is met from spontaneous
                        and voluntary Bhents or offerings by Satsangis, under the administration of the Central
                        Administrative Council, Soami Bagh, Agra.
                        <br /><br />&emsp;&emsp;Five or six months after the departure of Soamiji Maharaj, Huzur Maharaj
                        started construction of the Samadh of Soamiji Maharaj on this very spot (of elevated land),
                        which was completed in 1879. This Samadh was very small and simple and was built of red
                        sandstone. When His Samadh was constructed at that spot, it became clear that by Guru Dwara,
                        Soamiji Maharaj had meant His Samadh. Regarding the construction of Holy Samadh of Soamiji
                        Maharaj, Huzur Maharaj was pleased to observe that - "It is very essential and proper that a
                        suitable building be constructed in memory of the
                        ...
                        been preserved".
                        <br /><br />&emsp;&emsp;When Huzur Maharaj was Post Master General, He used to go off and on to
                        various states for opening new post offices. The Maharaja of Gwalior State gladly made a present
                        of Rs. 10,000/- to Him which He initially refused, but later accepted after approval from the
                        Government. The above sum was spent on the construction of Soamiji Maharaj's holy Samadh and the
                        boundary walls of Soami Bagh.
                        <br /><br />&emsp;&emsp;In 1904, for the first time, in His Mauj, Maharaj Saheb conveyed that a
                        magnificent building be constructed. "Just as Radhasoami Faith is a unique Faith to illuminate
                        the entire world with the brightness
                        ...
                        varied styles and forms of architecture from all races and nations". Thus, the idea of erecting
                        a magnificent and stupendous Samadh building befitting the memory of the August Founder of
                        Radhasoami Faith, first occurred to Maharaj Saheb, the third Sant Sat Guru of the Faith.
                        Accordingly, the foundation was laid by Him in 1904. The date of foundation laying was Baisakh
                        Shukl Panchmi, Wednesday, Samvat 1961 Vikram, corresponding to 20<sup>th</sup> April 1904.
                        <br /><br />&emsp;&emsp;Babuji Maharaj appointed Lala Tota Ram as the Supervising Engineer,
                        Samadh Works, Soami Bagh. Agra. Lala Tota Ram joined on 1<sup>st</sup> December 1907. The
                        present hall of the Samadh was constructed in 1925 using the same foundation that was laid in
                        1904 for the Samadh of Soamiji Maharaj. While delivering a discourse on August 23, 1937 in the
                        open Satsang held in the Samadh hall, Babuji Maharaj was graciously pleased to pronounce - "If
                        replica of Sat Lok is there on the surface of earth anywhere, it is here, it is here,
                        it is here.
                        "Saying or thinking that the Samadh is also a temple is not proper. It is also not proper to
                        think that one will obtain salvation through Samadhs. The ashes of the past Sants have been kept
                        in Samadhs and doing this is an indication of
                        ...
                        <br /><br />&emsp;&emsp;There is a spiritual significance to the measure of '68' in the 68 sq.ft
                        main hall. There are said to be 68 places of pilgrimage. Hence by visiting Holy Samadh of
                        Soamiji Maharaj, one will earn as much spiritual sanctity or derive as much spiritual benefit,
                        as one does by visiting 68 pilgrimage sites, of course in the mood of sincere devotion.
                ...
                <div class="row">
                    ...
                    <div class="col-md-10" style=" text-align: justify;outline:none" tabindex="1">
                        ...
                        <h4>BHAJAN GHAR
                            <span>
                                <a target="_blank"
                                    href="https://www.google.co.in/maps/place/Soamibagh,+Dayal+Bagh,+Agra,+Uttar+Pradesh+282005/@27.2202137,78.0031937,16z/data=!3m1!4b1!4m5!3m4!1s0x397479fd2d86d455:0x6aa0c1ed56929d09!8m2!3d27.2204956!4d78.0074086?hl=en"
                                    id="map2">
                                    <img src="../images/location.jpg" style="outline:none;" height="25" width="25"
                                        alt="bottle" class="thumbnails" />
                                </a>
                        ...
                        &emsp;&emsp;Bhajan Ghar is located in the premises of Soami Bagh, Agra. Soamiji Maharaj visited
                        Soami Bagh daily and returned
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 " id="kothi" style="text-align: justify;outline:none" tabindex="1">
                        ...
                        &emsp;&emsp;Kothi of Babuji Maharaj is located in the premises of Soami Bagh, Agra. Babuji
                        Maharaj lived in a rented house in Atarsooiya, Allahabad. A little further away, lived Maharaj
                        Saheb. For about 40 years, Satsang was held in this lane. The number of Satsangis was increasing
                        day by day. On the occasions of holidays and festivals, there used to be such a great rush that
                        many people could neither get Darshan nor hear discourses properly. For office work, the space
                        was not adequate. For lodging out station Satsangis, buildings were rented. Thus, hundreds of
                        rupees were spent on rent every month. Ultimately, Babuji Maharaj decided to shift the Satsang
                        headquarters from Allahabad to Soami Bagh, Agra. There were many requests and supplications from
                        the Satsangis of Allahabad against this. Babuji Maharaj said that Huzur Maharaj had ordered Him
                        to pass the last days of His life in Soami Bagh, Agra.
                        <br /><br />&emsp;&emsp;The Kothi (house) of Babuji Maharaj had been constructed in Soami Bagh
                        in 1922 itself. Babuji Maharaj arrived permanently in His Kothi at 7:30 PM on November 29, 1937.
                        Babuji Maharaj's Kothi was His place of residence. It was here that Babuji Maharaj held Satsang
                        and it was here that He left His mortal coil and departed to His Nij Dham. After the departure
                        of Babuji Maharaj, four Satsangs are regularly held every day in Soami Bagh, of which two
                        Satsangs, (one in the morning and one in the evening), are held at Babuji Maharaj's Kothi.
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-2 " style="text-align: justify; margin-bottom: 10px; max-height: 180px ">
                        <img src="images/radha.png " style="border-radius:70% " alt="image2 " width="180 "
                            height="180 " />
                    </div>
                    <div class="col-md-10 " id="Bagh " style="text-align: justify;outline:none " tabindex="1">
                        <h4>RADHA BAGH, AGRA
                            <span>
                                <a target="_blank" href="https://goo.gl/maps/Ci8zGY52xKD2" id="map4">
                                    <img src="../images/location.jpg" style="outline:none;" height="25" width="25"
                                        alt="bottle" class="thumbnails" />
                                </a>
                            </span>
                        </h4>
                        &emsp;&emsp;Radha Bagh is located in Agra city, 2.5 kms from Soami Bagh. In Soami Bagh, when the
                        Samadh built of red sand
                ...
                <div class="row">
                    <div class="col-md-2 " style="text-align: justify; margin-bottom: 10px; max-height: 180px">
                        <img src="images/gurudhuvara.png" style="border-radius:70%" alt="image2" width="180"
                            height="180" />
                    </div>
                    <div class="col-md-10 " id="Gali" style="text-align: justify;outline:none" tabindex="1">
                        ...
                        &emsp;&emsp;Panni Gali is a lane situated in Agra city, 6.5 kms from Soami Bagh. In this lane is
                        a residence which is the place of birth and departure to eternal abode of Param Purush Puran
                        Dhani Soamiji Maharaj and this is the place where He resided. Here, there is a small room within
                        another room. This place has a special significance.
                    ...
                    <div id="readmore12" style="text-align: justify; display: none ">
                        ...
                        <ul>
                            <li class="gurudwaraList ">Where on Monday the 24<sup>th</sup> August 1818 Param Purush
                                Puran Dhani Soamiji Maharaj was born.</li>
                            <li class="gurudwaraList ">Where for a number of years Soamiji Maharaj performed Abhyas.
                            </li>
                            <li class="gurudwaraList ">Where on Sunday the 14<sup>th</sup> November 1858 took place the
                                first historic meeting between Soamiji Maharaj and Huzur Maharaj.</li>
                            <li class="gurudwaraList ">Where Soamiji Maharaj initiated Huzur Maharaj.</li>
                            <li class="gurudwaraList ">Where on Friday the 15<sup>th</sup> February 1861, Soamiji
                                Maharaj started General Satsang open to all.</li>
                            <li>Where in January 1874, Soamiji Maharaj initiated Babuji Maharaj.</li>
                            <li>Where on Saturday the 15<sup>th</sup> June 1878, Soamiji Maharaj left His mortal coil.
                            </li>
                        </ul>
                        &emsp;&emsp;It is said that during the period of Soamiji Maharaj, Panni Gali was in a very bad
                        condition. At some places, there were pitfalls, at others there were slopes or inclines. The
                        stinking water from the lavatories used to flow here, there and everywhere in the lane. There
                        was always the danger of slipping and breaking one's limbs. The residential house of Soamiji
                        Maharaj was also of kachcha bricks (made of unbaked bricks and mud) and small. In fact, Panni
                        Gali, where Soamiji Maharaj assumed bodily form, established and held Satsang for years, was a
                        place fit only for ardent lovers and true devotees like Huzur Maharaj who were totally oblivious
                        of pitfalls and dirty drains in the lane. Babuji Maharaj was once pleased to declare that Panni
                        Gali is really Prem Gali, that is, the lane of love.
                        <br /><br />&emsp;&emsp;The old residential house of Soamiji Maharaj was demolished and
                        reconstructed under the supervision of the late Sri Tota Ram, the Supervising Engineer of the
                        Radhasoami Samadh Works. Babuji Maharaj had instructed Sri Tota Ram in the following words: "As
                        Soamiji Maharaj was born and had resided and held His Satsang in this house for 60 years,
                        ...
                        be used during the course of construction of this house along with new material ". The new house
                ...
                <div class="row">
                    <div class="col-md-2 " style="text-align: justify; margin-bottom: 10px; max-height: 180px ">
                        <img src="images/pipal.png " style="border-radius:70% " alt="image2 " width="180 "
                            height="180 " />
                    </div>
                    <div class="col-md-10 " id="Agra " style="text-align: justify;outline:none " tabindex="1">
                        <h4>PIPAL MANDI, AGRA
                            <span>
                                <a target="_blank" href="https://goo.gl/maps/LDnityCEEvA2" id="map6">
                                    <img src="../images/location.jpg" style="outline:none;" height="25" width="25"
                                        alt="bottle" class="thumbnails" />
                                </a>
                            </span>
                        </h4>
                        &emsp;&emsp;Pipal Mandi is an area situated in Agra city, 6.5 kms from Soami Bagh. This was the
                        residence of Huzur
                        ...
                        <br /><br />&emsp;&emsp;Two houses adjacent to each other were purchased in front of Huzuri
                        Bhawan
                ...
                <div class="row">
                    <div class="col-md-2 " style="text-align: justify;  margin-bottom: 10px; max-height: 180px;">
                        <img src="images/soamibagh.png" style="border-radius:70%" alt="image2" width="180"
                            height="180" />
                    </div>
                    <div class="col-md-10 " id="varnasi" style="text-align: justify;outline:none" tabindex="1">
                        <h4>SOAMI BAGH, VARANASI (BENARAS)
                            <span>
                                <a style="outline:none;" target="_blank"
                                    href="https://www.google.co.in/maps/place/Aaj+Bhawan,+Sant+Kabir+Rd,+Bulanala,+Varanasi,+Uttar+Pradesh+221001/@25.3195873,83.007892,17z/data=!3m1!4b1!4m5!3m4!1s0x398e2e17587adf7d:0xaa481466a4ffd3ad!8m2!3d25.3195873!4d83.0100807?hl=en"
                                    id="map7">
                                    <img src="../images/location.jpg " style="outline:none; " height="25 " width="25 "
                                        alt="bottle " class="thumbnails " />
                                </a>
                        ...
                        &emsp;&emsp;As in Soami Bagh, Agra, Soamiji Maharaj had pointed towards a mound, on which His
                        Samadh is presently being built, and had observed that a Gurudwara would stand there, so also
                        when the hall (Satsang-hall) was under construction in Soami Bagh, Varanasi, Maharaj Saheb had
                        observed that He would hold Satsang there. The hall in Soami Bagh, Varanasi, where Satsang is
                        held now-a-days, was under construction in Maharaj Saheb's time and the same was converted into
                        His Samadh after His departure.
                        <br /><br />&emsp;&emsp;On the north of the hall there is a platform like a stage, in the centre
                        of which lies the Samadh of Maharaj Saheb, with sufficient space provided on either side for
                        ladies to sit during Satsang (congregation). The balconies on the three sides of the hall facing
                        the Samadh are also meant for ladies to sit during congregation. The iron gate of Soami Bagh was
                        fabricated in Calcutta (now Kolkata). When the gate was being fixed up, the Maharaja (ruler) of
                        Varanasi happened to pass that way in his horse driven carriage. Amazed to see such a big gate,
                        he remarked that it was unbelievable that a gate bigger than that of his own palace existed in
                        his State! When he was told that it was the Guru-Darbar (Guru's court), he bowed his head in
                        reverence. It is said that even today when the ruler of Kashi and his heirs pass that way, they
                        bow their heads down in reverence before Soami Bagh.
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="GenInfo" class="row " divType="pageContent">
            <div class="col-md-12" style="padding-right:50px;">
                ...
                The day to day administration of Radhasoami Satsang is looked after by Central Administrative Council,
                Radhasoami Satsang, Soami Bagh, Agra, India. Secretary can be contacted at <b>rssoamibagh@gmail.com</b>
                <div class="col-md-12 " style="text-align: justify;outline:none" tabindex="1">
                    ...
                    All Initiated (Upadeshi) Satsangis, can send the monetory Offerings (Bhent) via
                    Cash/Cheque/IMPS/NEFT/RTGS to the bank accounts given below.
                    <br />
                    <br />
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                UBIN0530565 (Fifth and Eighth character is zero)
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <br />
                    <b><u>Notes:</u></b><br />
                    1. PAN number is mandatory for all Offerings (Bhent) having amount of more than and including INR
                    5000.
                    <br />
                    2. After transferring the funds, it is mandatory to send the details of the depositor viz. Name,
                    full postal address with pin code and mobile number and amount remitted, to Satsang office by post
                    or e-mail. Contact details are given below.
                    ...
                    All Initiated (Upadeshi) Satsangis can send the monetory Offerings (Bhent) in foreign currency to
                    the bank account given below. If you wish to offer Bhent in Indian Rupees, please follow the details
                    mentioned above in <b>section-A</b>
                    <br />
                    <br />
                    <table>
                        <tr>
                    ...
                    <br />
                    <b><u>Notes:</u></b><br />
                    1. After transferring the funds, it is mandatory to email the following details of the depositor to
                    Satsang office at <b>rssoamibagh@gmail.com</b>.
                    <br />
                    <ul>
                        <li>Postal address</li>
                        <li>Mobile number</li>
                        <li>Amount remitted</li>
                        <li>Break-up of Bhent, if relevant (eg: 1. USD 50 as Samadh Bhent, 2. USD 20 as Other Bhent)
                        </li>
                        <li>Currency</li>
                    </ul>
                    2. Explicitly mention if Prasad has to be sent to the Satsangi. If yes, include the delivery details
                    like Name, full postal address and contact number.
                    <br />
                    <br />
                    ...
                    <br />
                    <h4>INITIATION</h4>
                    Any seeker desiring initiation, should write to "The Secretary, Central Administrative Council,
                    Radhasoami Satsang, Soami Bagh, Agra-282005, India" or email at <b>rssoamibagh@gmail.com</b> to get
                    the exact process and guidance.
                    Seeker has to visit Soami Bagh, Agra and make a request to The Secretary, Central Administrative
                    Council, Radhasoami Satsang, Soami Bagh, Agra, India of his/her intent.
                    <br />Seeker is expected to confirm
                    <ul>
                        <li>He/She believes Radhasoami to be the true name of the Supreme Being.</li>
                        <li>He/She is willing to totally abstain from any animal food (including fish and eggs) and
                            intoxicants of all types.</li>
                        <li>He/She is willing to give up all past faiths and beliefs, based on a proper understanding of
                            Radhasoami faith.</li>
                    </ul>
                    Normally the seeker is required to visit Soami Bagh, Agra. In case he/she is not in a position to
                    visit Soami Bagh, Agra for certain reasons, there is a provision for granting Initiation through
                    letter in which case a senior Satsangi in the same region can meet and explain the modes of practice
                    personally. This is granted only in exceptional circumstances and normally it is expected that a
                    seeker will take his initiation at Soami Bagh, Agra only.
                    <br />
                    <!--This section is for Accommodation details-->
                    <h4>ACCOMMODATION</h4>
                    Limited air conditioned and non air conditioned accommodation is available in Soami Bagh, Agra and
                    Soami Bagh, Varanasi. Kindly contact Secretary, Radhasoami Satsang, Soami Bagh, Agra, India.
                    Request for accommodation be mailed to <b>acco@rssoamibagh.org</b>
                    <br />
                    <br />While writing/e-mailing, kindly mention all details like ID card number, Name of the primary
                    contact person, residence address, contact number, email ID, number of people visiting, duration of
                    stay and any special assistance, if required.
                    <br />
                ...
                <div class="col-md-12 " style="text-align: justify;outline:none" tabindex="1">
                    ...
                    <br /><a href="https://en.wikipedia.org/wiki/Agra">Click here</a> to get the details of <b>Agra</b>
                    from Wikipedia
                    <br /><a href="https://en.wikipedia.org/wiki/Varanasi">Click here</a> to get the details of
                    <b>Varanasi</b> from Wikipedia
                    <br />
                </div>
                ...
                <ContentTemplate>
                    <div class="col-md-12">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="Label3" Text="Author/Translator"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlorderbookauthor" runat="server" Width="228px" Height="25px"
                                        AutoPostBack="true" AppendDataBoundItems="true">
                                        <asp:ListItem Value="0" Text="ALL"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="Label4" Text="Related To"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlorderbookrelated" runat="server" Width="228px"
                                        Height="25px" AutoPostBack="true" AppendDataBoundItems="true">
                                        <asp:ListItem Value="0" Text="ALL"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="Label5" Text="Language"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlorderbooklanguage" runat="server" Width="228px"
                                        Height="25px" AutoPostBack="true" AppendDataBoundItems="true">
                                        <asp:ListItem Value="0" Text="ALL"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                        ...
                        <span style="margin-left:5px">
                            <b>
                                <asp:Button runat="server" ID="orderbooksearch" Text="SEARCH" Causevalidater="true" />
                                </b>&emsp;<u style=" color: #337ab7;">Note:</u> Set all search criteria to blank, keep
                            the search box blank and click Search button to reset the table.
                        </span>
                        <br /> <br />
                        ...
                        <asp:Label runat="server" ID="lblerr"
                            tyle="color: black; padding-left: 15px;font-size:20px;display:none" Font-Bold="true">
                        </asp:Label>
                        <asp:Label style="color: black; padding-left: 15px;font-size:20px;display:none" Font-Bold="true"
                            runat="server" id="lblorderbook" Text="No matches found. Please try again..."></asp:Label>
                        <br />
                        <br />
                        <asp:UpdatePanel runat="server" ID="orderupade">
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="Panel6" runat="server" ScrollBars="Auto" Width="100%">
                                    <asp:GridView ID="OrderBok" runat="server" Width="100%" AllowPaging="true"
                                        AutoGenerateColumns="false" AlternatingRowStyle-BackColor="#e5e5e5"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label runat="server" ID="bookid" Style="display:none;"
                                                        class="status" Text='<%#Eval("bNameEng")%>'></asp:Label>
                                                    <%--<asp:HiddenField runat ="server" value='<%#Eval("book_id")%>'
                                                    ID="bookid" />--%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Book Name">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="bNam" runat="server" Text='<%# Bind("bNameEng") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="true" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Author/Translator">
                                                <ItemTemplate>
                                                    <asp:Label ID="authTran" runat="server"
                                                        Text='<%# Bind("authTransEng") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="true" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Language">
                                                <ItemTemplate>
                                                    <asp:Label ID="lanEng" runat="server" Text='<%# Bind("langEng") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="true" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Publication">
                                                <ItemTemplate>
                                                    <asp:Label ID="puEng" runat="server" Text='<%# Bind("pubEng") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="true" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Related To">
                                                <ItemTemplate>
                                                    <asp:Label ID="relat" runat="server" Text='<%# Bind("related") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="true" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Book Summary">
                                                <ItemTemplate>
                                                    <asp:Label ID="sumaryEng" runat="server"
                                                        Text='<%# Bind("summaryEng") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="true" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Options">
                                                <ItemTemplate>
                                                    <a onclick="logcheck('<%#Eval("pdfLink")%>');"
                                                        style="cursor:pointer;">Read Online</a>
                                                    &emsp;&emsp;<a style="cursor:pointer;" data-toggle="tooltip"
                                                        title="Download" onclick="downcheck('<%#Eval("pdfLink")%>')"
                                                        download><span class="glyphicon glyphicon-save"></a>
                                                    <%--                                                                 <ItemTemplate>
                                                                    <a href="<%#Eval("pdfLink")%>" target="_blank">Read
                                                    Online</a>
                                                    &emsp;&emsp;<a href="<%#Eval("pdfLink")%>" download><span
                                            ...
                                            <%--  <asp:TemplateField HeaderText="Book Order">
                                                            <ItemTemplate>
                                                                <input onclick="logcheck(this.id);" id='<%#Eval("book_id")%>'
                                            type="button" value="Order Book" />--%>

                                            <%--<asp:Button OnClientClick="logcheck(this);" ID='<%#Eval("book_id")%>'
                                            runat="server" Text="Order Book"></asp:Button>--%>
                                            <%-- </ItemTemplate>
                                                            <ItemStyle Wrap="true" />
                                                        </asp:TemplateField>--%>
                                        </Columns>
        ...
        <div id="ContactUs" class="row" divType="pageContent">
            <div class="col-md-12">
                <h3>CONTACT US</h3>
                If you need any information or have any feedback or suggestions, kindly email to
                <b>rsfaithsoamibaghagra@gmail.com</b>
        ...
        <nav class="navbar fixed-bottom navbar-light bg-info" id="divMediaPlayer" style="display:none;">
            <div>
                <label class="lead bg-primary"
                    style="width:100%;padding:10px;margin-left:-10px;margin-right:-10px;">Playlist</label>
                ...
                <button id="btnShowPlaylist" class="btn border playlistButton" style="float:right;" state="off">Show
                    Playlist</button>
